...
local options = {
    ...
    STEP_LENGTH_NAMES = {
        "1 bar", "1/2", "1/3", "1/4", "1/6", "1/8", "1/12", "1/16", "1/24",
        "1/32", "1/48", "1/64"
    },
...
local function stop() all_notes_off() end

local function reset_pattern() clk:reset() end
...
function draw_gridscales() gridscales:redraw() end
